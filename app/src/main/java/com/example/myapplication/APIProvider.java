...
public class APIProvider extends ContentProvider {
    public final static String DBNAME = "APIs";
    ...
    public final static String TABLE_NAMESTABLE = "APIs";
    public static final String AUTHORITY = "aprovider";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        int ids = values.getAsInteger("ID");
